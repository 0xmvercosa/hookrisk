...
| Gate | ✅ Passed |
| Findings | none · 3 classifications |
...
- **Complexity**
  - hook-profile metrics: callbacksImplemented=1, callbacksDeclared=3, stateWritesInCallbacks=3, externalCallsInSwapPath=3, internalFunctionsReachableFromCallbacks=8, usesReturnsDelta=true, hasOwnerOnlyFunctions=false
